    ...
    <div class="prize-rules-index">
        <myTable ref="listTable" :listConf="listConf" @select="selectRow" @searchReset="searchReset">
            ...
            <template slot="formBtn" >
                <Button type="primary" @click="jumpPage({ path: '/prizeManage/prizeRules/add' })"><Icon type="plus-round"></Icon>策略添加</Button>
            </template>
        </myTable>
    </div>
</template>
        ...
        return {
            ...
            listConf: {
                ...
                columns: [
                    ...
                    { title: '奖金金额', align: 'center', key: 'money', width: 90 },
                            ...
                            h('Button', {
                                ...
                                on: {
                                    click: () => {
                                        ...
                                        this.jumpPage('/prizeManage/prizeRules/edit/' + id)
                                    }
                                }
                            }),
                            h('Button', {
